...
<div id="app">
    <div class="row">
        <div class="col-sm">
            <img src="./img/lgo-removebg-preview.png" alt="">
            <h1>Cotización para <?php echo htmlentities($cotizacion->descripcion) ?></h1>
            <h4>Cliente: <?php echo htmlentities($cotizacion->Nombre) ?> <?php echo htmlentities($cotizacion->Apellidos) ?></h4>
                    ...
                    <table class="table table-striped">
                        ...
                        foreach ($servicios as $servicio) {
                            ...
                            <tr>
                                ...
                                <td>S/.<?php echo htmlentities($servicio->costo) ?></td>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">S/.<strong><?php echo $costoTotal ?> </strong></td>
                            <td class="text-nowrap"><strong><?php echo $tiempoTotal ?> </strong>
                            </td>
                        </tr>
                        </tfoot>
                    </table>
    ...
    <div class="row d-print-block d-sm-none">
        <hr>
        <div class="col-sm">
            Cualquierr reclamo u Observacion se le atendera correctamenteu con amabilidad devida envienos un correo al:
            <strong>plusindustrias@hotmail.com</strong>
        </div>
    </div>
    <div class="row">
        <div class="col-sm">
        ...
        new Vue({
            ...
            methods: {
                imprimir() {
                    ...
                    document.title = "Cotización de <?php echo htmlentities($cotizacion->descripcion) ?> para <?php echo htmlentities($cotizacion->Nombre) ?> <?php echo htmlentities($cotizacion->Apellidos) ?>";
                    window.print();
